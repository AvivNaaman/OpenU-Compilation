...
void gen_3arg(quad_code table, quad_instructions instruction, int arg1, int arg2, int arg3) {
...
void gen_2arg(quad_code table, quad_instructions instruction, int arg1, int arg2) {
